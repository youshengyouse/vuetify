...
```
git clone git@github.com:youshengyouse/vuetify.git _vuetify
```
...
...
To install them, you can run: npm install --save vuetify/es5/locale vuetify/es5/mixins/measurable vuetify/es5/mixins/proxyable vuetify/es5/mixins/t
hemeable vuetify/es5/services/goto vuetify/es5/services/goto/easing-patterns vuetify/es5/util/colors vuetify/es5/util/helpers
```

解决办法：

1. `yarn clean`删除所有包`node_modules目录`，`yarn.lock` 文件，` yarn cache clean `
2. 进入根目录，我的是` D:\www\common\source_js\_vuetify `
...
To install them, you can run: npm install --save vuetify/es5/locale vuetify/es5/mixins/measurable vuetif
y/es5/mixins/proxyable vuetify/es5/mixins/themeable vuetify/es5/services/goto vuetify/es5/services/goto/easing-patterns
 vuetify/es5/util/colors vuetify/es5/util/helpers
```

修改

`D:\www\common\source_js\_vuetify\node_modules\vuetify\build\build-lib.js`中改为如下
